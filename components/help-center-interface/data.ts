...
export const POPULAR_ARTICLES: Article[] = [
  {
    id: 1,
    title: "Getting Started with CASCADIAN",
...
export const FAQS: FAQ[] = [
  {
    id: "faq-1",
    question: "What is CASCADIAN?",
    answer:
      "CASCADIAN is an advanced AI-powered crypto trading and DeFi platform that helps users automate their trading strategies, manage their portfolios, and maximize their returns in the cryptocurrency market. It offers a range of tools including AI trading bots, market analysis, portfolio tracking, and DeFi integrations.",
  },
  {
    id: "faq-2",
  ...
  {
    id: "faq-3",
    question: "Is my data secure on CASCADIAN?",
    answer:
      "Yes, security is our top priority. CASCADIAN uses industry-standard encryption for all data, implements two-factor authentication, and never stores your exchange API secret keys on our servers. We use a secure architecture that keeps your trading data and personal information protected at all times.",
  },
  {
    id: "faq-4",
    question: "What exchanges are supported?",
    answer:
      "CASCADIAN currently supports major exchanges including Binance, Coinbase Pro, Kraken, KuCoin, and FTX. We're continuously adding support for more exchanges to provide you with the most comprehensive trading experience possible.",
  },
  {
    id: "faq-5",
  ...
  {
    id: "faq-6",
    question: "Can I use CASCADIAN on mobile devices?",
    answer:
      "Yes, CASCADIAN is fully responsive and works on desktop, tablet, and mobile devices. You can access all features and monitor your trading activities on the go through any modern web browser. We also offer mobile notifications to keep you updated on important events.",
  },
  {
    id: "faq-7",
    question: "How do I connect my wallet?",
    answer:
      "To connect your wallet, go to the Wallets section, click on 'Connect Wallet', and choose your preferred wallet provider (MetaMask, WalletConnect, Coinbase Wallet, etc.). Follow the authentication prompts to securely connect your wallet to CASCADIAN.",
  },
  {
    id: "faq-8",
