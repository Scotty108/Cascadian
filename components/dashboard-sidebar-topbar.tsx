  ...
  return (
    <div className="min-h-screen w-full relative bg-[#F1F1F1] dark:bg-[#0a0a0a] animated-blob-bg">
      <div className="relative z-10">
        ...
        <div className={cn("duration-300", collapsed ? "translate-x-[72px] max-w-[calc(100%-72px)]" : "translate-x-[72px] max-w-[calc(100%-280px)] md:translate-x-[280px] md:max-w-[calc(100%-280px)]")}>
          <Topbar />
