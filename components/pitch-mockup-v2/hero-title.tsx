  ...
  return (
    <div className="flex items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-5 text-xs">
        <div className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-md border border-transparent hover:border-cyan-400/50 hover:bg-cyan-50/50 dark:hover:bg-cyan-900/20 transition-all duration-200 cursor-default">
          <TrendingUp className="w-3.5 h-3.5 text-zinc-400" />
          <span className="text-zinc-500">Vol</span>
          <span className="font-mono font-semibold tabular-nums text-zinc-700 dark:text-zinc-300">$24.5M</span>
        </div>
        <div className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-md border border-transparent hover:border-cyan-400/50 hover:bg-cyan-50/50 dark:hover:bg-cyan-900/20 transition-all duration-200 cursor-default">
          <Users className="w-3.5 h-3.5 text-zinc-400" />
          <span className="text-zinc-500">Traders</span>
          <span className="font-mono font-semibold tabular-nums text-zinc-700 dark:text-zinc-300">45.8K</span>
        </div>
        <div className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-md border border-transparent hover:border-cyan-400/50 hover:bg-cyan-50/50 dark:hover:bg-cyan-900/20 transition-all duration-200 cursor-default">
        ...
        <div className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-md border border-transparent hover:border-cyan-400/50 hover:bg-cyan-50/50 dark:hover:bg-cyan-900/20 transition-all duration-200 cursor-default">
          ...
          <span className="font-mono font-semibold tabular-nums text-zinc-700 dark:text-zinc-300">$2.1M</span>
        </div>
      </div>
    </div>
  );
