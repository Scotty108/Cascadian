  ...
  return (
    <div className="h-full bg-card border border-border rounded-xl p-5 flex flex-col shadow-md hover:shadow-lg transition-shadow duration-200">
      ...
      <div className="space-y-4 text-sm flex-1">
        {/* Hedge Funds */}
        <div className="border-l-2 border-border pl-3 py-1 transition-all duration-200 hover:border-l-cyan-400 hover:bg-cyan-50/50 dark:hover:bg-cyan-900/20 -ml-0.5 rounded-r">
      ...
      {/* Action Summary */}
      <div className="mt-4 pt-3 border-t border-border">
        <div className="flex items-center justify-between p-2 -mx-2 rounded-lg bg-muted/30 transition-all duration-200 hover:bg-cyan-50/50 dark:hover:bg-cyan-900/30 hover:scale-[1.01]">
          <div>
            <div className="text-[10px] text-muted-foreground uppercase tracking-wide mb-1">
              Verdict
            </div>
            <div className="text-sm font-semibold text-blue-500">BUY YES @ <span className="font-mono tabular-nums">87¢</span></div>
          </div>
          <div className="text-right">
            <div className="text-[10px] text-muted-foreground uppercase tracking-wide mb-1">
              Target
            </div>
            <div className="text-sm font-mono font-semibold tabular-nums text-emerald-500">94¢</div>
          </div>
        </div>
      </div>
    </div>
