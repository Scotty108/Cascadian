...
export function MarketAnalysisCard() {
  return (
    <div className="h-full bg-card border border-border rounded-xl p-4 flex flex-col">
      {/* Header */}
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          <FileText className="w-4 h-4 text-muted-foreground" />
          <span className="text-xs font-semibold">Market Analysis Report</span>
        </div>
      ...
      <div className="space-y-2.5 text-[11px] leading-relaxed flex-1">
        ...
        <div className="border-t border-border pt-2.5 mt-2">
          ...
          <div className="grid grid-cols-2 gap-x-4 gap-y-1.5 text-[10px]">
            <div className="flex items-center justify-between">
              ...
              <span className="font-mono">2.3% <span className="text-emerald-500">↓0.5%</span></span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-muted-foreground">Unemployment</span>
              <span className="font-mono">4.2% <span className="text-muted-foreground/50">—</span></span>
            </div>
            <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-mono text-blue-500">89%</span>
            </div>
            <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-mono text-blue-500">82% YES</span>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-border pt-2">
          <div className="flex flex-wrap gap-2 text-[9px]">
            <span className="text-blue-500 cursor-pointer hover:underline flex items-center gap-0.5">
