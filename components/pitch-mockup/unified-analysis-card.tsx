    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <div className="flex justify-between text-xs mt-1.5">
          <span className="font-mono text-zinc-700 dark:text-zinc-300">82% YES</span>
          <span className="text-zinc-500 font-mono">18% NO</span>
        </div>
      </div>
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        {correlatedEvents.map((event, index) => (
          <div
            key={index}
            className={`flex items-start justify-between p-3 border border-zinc-200 dark:border-zinc-700 ${CORNER_STYLE === "rounded" ? "rounded-lg" : "rounded-md"} hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors cursor-pointer`}
          >
