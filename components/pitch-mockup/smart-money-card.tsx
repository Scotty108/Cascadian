    ...
    <div className="h-full bg-card border border-border rounded-xl p-5 flex flex-col">
      ...
      <div className="mb-4">
        ...
        <div className="flex justify-between text-xs mt-1.5">
          ...
          <span className="text-muted-foreground font-mono">18% NO</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 mt-4 pt-4 border-t border-border flex-1">
        <div className="border border-border rounded-lg p-2.5">
          ...
          <div className="text-sm font-mono font-semibold">38 YES / 12 NO</div>
        </div>
        ...
        <div className="border border-border rounded-lg p-2.5">
          ...
          <div className="text-sm font-mono font-semibold text-emerald-500">+$2.3M YES</div>
        </div>
        ...
        <div className="border border-border rounded-lg p-2.5">
          ...
          <div className="text-sm font-mono font-semibold">$125K</div>
        </div>
        ...
        <div className="border border-border rounded-lg p-2.5">
          ...
          <div className="text-sm font-mono font-semibold">89%</div>
        </div>
      </div>
