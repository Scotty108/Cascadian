...
export function ScoreComparisonCard() {
  ...
  return (
    <div className={`h-full bg-gradient-to-b from-white to-zinc-50 dark:from-zinc-900 dark:to-zinc-900 border border-zinc-200 dark:border-zinc-800 ${CORNER_STYLE === "rounded" ? "rounded-xl" : "rounded-lg"} p-3 flex flex-col`}>
      {/* Header */}
      <div className="mb-3">
      ...
      <div className="mb-3 pb-3 border-b border-zinc-200 dark:border-zinc-700">
        <div className="flex items-baseline gap-3">
          <div className="flex items-baseline gap-1.5">
            <span className="text-3xl font-mono font-bold text-zinc-900 dark:text-zinc-100">94%</span>
            <span className="text-sm text-zinc-500">YES</span>
          </div>
          <span className="text-zinc-300 dark:text-zinc-600">/</span>
          <div className="flex items-baseline gap-1.5">
            <span className="text-xl font-mono text-zinc-400">6%</span>
      ...
      <div className={`bg-gradient-to-br from-zinc-50 to-zinc-100/50 dark:from-zinc-800/80 dark:to-zinc-900 border border-zinc-200 dark:border-zinc-700 ${CORNER_STYLE === "rounded" ? "rounded-lg" : "rounded-md"} p-3 mb-2`}>
        ...
        <div className="flex gap-3">
          <div className="flex-1">
            <div className="flex items-baseline gap-1.5">
              <span className="text-xl font-mono font-bold text-zinc-900 dark:text-zinc-100">87%</span>
              <span className="text-sm font-medium text-zinc-500">YES</span>
            </div>
            <div className="text-[10px] text-zinc-500">87¢</div>
          </div>
          <div className="w-px bg-zinc-200 dark:bg-zinc-700" />
          <div className="flex-1">
            <div className="flex items-baseline gap-1.5">
              <span className="text-xl font-mono font-bold text-zinc-900 dark:text-zinc-100">13%</span>
              <span className="text-sm font-medium text-zinc-500">NO</span>
            </div>
            <div className="text-[10px] text-zinc-500">13¢</div>
          </div>
        </div>
      </div>

      {/* Smart Money Activity - Toggle between sparkline and heatmap */}
      <div className={`bg-gradient-to-br from-zinc-50 to-zinc-100/50 dark:from-zinc-800/80 dark:to-zinc-900 border border-zinc-200 dark:border-zinc-700 ${CORNER_STYLE === "rounded" ? "rounded-lg" : "rounded-md"} p-2.5 min-h-0 overflow-hidden`}>
        <div className="flex items-center justify-between mb-1.5">
          ...
          <span className="text-[10px] font-mono text-zinc-700 dark:text-zinc-300">82% YES</span>
        </div>
