  ...
  try {
    ...
    for (const row of assetData) {
      try {
        ...
        // Check if this hex value exists in token_cid_map with hex</parameter>
        ...
        const existingData = await existing.json();<parameter name="value"></parameter>, "<parameter name="type">section-break</parameter>
