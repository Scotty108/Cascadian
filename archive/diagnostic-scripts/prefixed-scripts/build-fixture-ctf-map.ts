/**
 * BUILD FIXTURE - CTF MAP
 *
 * Use ctf_token_map for 100% coverage (no ERC1155 join needed)
 */
...
async function main() {
  console.log('═══════════════════════════════════════════════════════════');
  console.log('FIXTURE BUILDER (CTF_TOKEN_MAP)');
  console.log(`Wallet: ${TARGET_WALLET}`);
  console.log('═══════════════════════════════════════════════════════════\n');

  // Get fills with token_ids from ctf_token_map
  console.log('📊 Loading fills with token_ids (via ctf_token_map)...\n');
  ...
  if (fills.length === 0) {
    ...
    console.log('  1. ctf_token_map.token_id format does not match clob_fills.asset_id');
    console.log('  2. No data for this wallet in ctf_token_map\n');
    return;
  }
