...
- **Simple:**\
  ...
  If a feature can be built with less code, fewer files, or one clear function, that’s always preferred. Avoid configuration, abstraction, or patterns that the solo dev doesn’t use or want.
- **Lovable:**\
