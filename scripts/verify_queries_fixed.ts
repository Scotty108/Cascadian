...
async function runQueries() {
  ...
  try {
    ...
    // Query 3b: ERC1155 transfers - try both from_address and to_address
    const q3b = await client.query({
      query: "SELECT COUNT(*) as transfer_count FROM default.erc1155_transfers WHERE from_address = '0x4ce73141dbfce41e65db3723e31059a730f0abad' OR to_address = '0x4ce73141dbfce41e65db3723e31059a730f0abad'",
      format: 'JSONCompact'
    });
    const q3bText = await q3b.text();
    const q3bData = JSON.parse(q3bText);
    console.log('Query 3b: SELECT COUNT(*) FROM erc1155_transfers WHERE from_address OR to_address = 0x4ce7...');
