#!/usr/bin/env tsx
/**
 * Generate Leaderboard Reports (Simple Approach)
 *
 * Queries pm_wallet_omega_stats directly with small LIMIT to avoid memory issues.
 * Progress headers are now disabled in the ClickHouse client.
 */
...
async function main() {
  ...
  console.log('Step 1: Querying whale wallets (volume >= $100k)...');
  console.log('');
