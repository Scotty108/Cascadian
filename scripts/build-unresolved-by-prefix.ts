...
async function buildUnresolvedByPrefix() {
  console.log('🔄 Building Missing Unresolved Positions (Batched by Condition ID Prefix)\n');
...
buildUnresolvedByPrefix().catch(console.error);
